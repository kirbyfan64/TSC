...
void cBeetleBarrage::Editor_Activate()
{
    ...
    // range
    CEGUI::Editbox* p_editbox = static_cast<CEGUI::Editbox*>(wmgr.createWindow("TSCLook256/Editbox", "editor_beetlebarrage_fly_distance"));
    ...
    // action area
    p_editbox = static_cast<CEGUI::Editbox*>(wmgr.createWindow("TSCLook256/Editbox", "editor_beetlebarrage_range"));
    ...
    p_editbox = static_cast<CEGUI::Editbox*>(wmgr.createWindow("TSCLook256/Editbox", "editor_beetlebarrage_count"));
